...
const char *gengetopt_args_info_purpose = "nanoShell";

const char *gengetopt_args_info_usage = "Usage: Projeto PA [OPTION]...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "Marta Santos - 2181351         Patricia Paulo - 2191239";

const char *gengetopt_args_info_help[] = {
  "  -h, --help         Print help and exit",
  "  -V, --version      Print version and exit",
  "  -f, --file=STRING  Executes command lines inside of file",
  "  -m, --max=INT      Maximum number of executions",
  "  -s, --signalfile   Creates a file with signals sent to nanoShell",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->signalfile_help = gengetopt_args_info_help[4] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVf:m:s", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'f':	/* Executes command lines inside of file.  */
          ...
          break;
        case 'm':	/* Maximum number of executions.  */
          ...
          break;
        case 's':	/* Creates a file with signals sent to nanoShell.  */
